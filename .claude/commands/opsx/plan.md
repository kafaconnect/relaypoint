...
write issue numbers into task-file frontmatter (`issue:`; tasks are per-file under `tasks/`, tasks.md is the generated index). OpenSpec owns definition; the board owns
state (one-way sync).
