# Delta for Deploy — realtime hardening

Adds the least-privilege `projector` NATS identity to the authoritative user model (RH-06) and
removes the duplicated mutable-tag deploy definitions (RH-10). The local
